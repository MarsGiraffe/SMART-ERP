...
public class Employee {
	...
	public Employee(int employee_num, int store_num, String employee_name, String id, String password, String email,
			String phone_num, String job_level, String hire_date, String hire_type, String resignation_day,
			String employee_photo, int auth, String store_name) {
